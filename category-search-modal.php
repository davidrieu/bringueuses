    ...
    jQuery(document).ready(function($) {
        ...
        if (!$('#bringueuses-category-modal').length) {
            ...
            \$submitBtn.on('click', function(e) {
                ...
                // Récupérer les catégories sélectionnées en excluant les parents si des enfants sont sélectionnés
                var selectedValues = [];

                // Parcourir chaque groupe de catégories
                $('.bringueuses-category-item').each(function() {
                    ...
                    // Si des sous-catégories sont cochées, on prend SEULEMENT les sous-catégories (pas le parent)
                    ...
                    // Sinon, si le parent est coché (sans enfants), on prend le parent
                        ...
                        selectedValues.push(value);
                        console.log('Catégorie parente sélectionnée (sans enfants):', label, '- Valeur:', value);
                    }
                });
